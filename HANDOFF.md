...
Deliver 0.3.1 through the existing annotated-tag release pipeline. The maintainer requested
...
[HOK-772](https://linear.app/hoklims/issue/HOK-772) tracks technical publication of 0.3.1: the
guarded content proof carried through project-managed hook chains and non-authorizing hook bypass
(ADR 0029). 0.3.0 was published under [HOK-752](https://linear.app/hoklims/issue/HOK-752).
...
- [Release scope and rollback](docs/releases/v0.3.1.md); previous release: [v0.3.0](docs/releases/v0.3.0.md)
...
- ADRs [0025](docs/adr/0025-explicit-index-recovery-records-new-verification.md),
  ...
  [0028](docs/adr/0028-explicit-config-migration-and-restoration.md) and
  [0029](docs/adr/0029-guarded-content-proof-in-project-managed-hook-chains.md)
...
Read main, annotated v0.3.1, npm gitHead, stable, GitHub Release and release-workflow jobs.
